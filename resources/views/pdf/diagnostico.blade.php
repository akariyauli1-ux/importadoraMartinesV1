...
<head>
    <meta charset="UTF-8">
    <title>Ficha de Diagnóstico - {{ $order->numero_ticket }}</title>
    <style>
        body {
        ...
        .header {
            border-bottom: 3px solid #e50914; /* Crimson Red bar */
            padding-bottom: 15px;
            margin-bottom: 25px;
        }
        .header table {
...
<body>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <span class="brand-subtitle">Servicio Técnico Especializado en Electrónica</span>
                </td>
    ...
    <!-- Selective checklist diagnostics -->
    <div class="section-title">Resultados de Revisión Técnica</div>
    <table class="details-table">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td style="font-weight: bold; background-color: #f1f3f5;">Diagnóstico y Observaciones</td>
    ...
    <div style="margin-top: 25px; width: 100%;">
        <div style="width: 65%; display: inline-block; vertical-align: top;">
            <div style="background-color: #f8f9fa; border: 1px solid #e50914; padding: 15px; border-radius: 4px;">
                <span style="font-size: 9pt; color: #555555; text-transform: uppercase;">Presupuesto Estimado Autorizado:</span><br>
                <span style="font-size: 18pt; font-weight: bold; color: #e50914;">Bs. {{ number_format($order->costo_estimado, 2) }}</span>
                <p style="font-size: 8pt; color: #6c757d; margin-top: 10px; line-height: 1.3;">
                    El cliente autorizó el presupuesto de forma formal mediante firma digital QR única. La alteración física de este documento constituye fraude (Código QR verificador incrustado).
                </p>
            </div>
        </div>
        <div style="width: 32%; display: inline-block; text-align: right; vertical-align: top;">
            <!-- Anti-fraud QR code -->
            <img src="data:image/png;base64,{{ $qrCode }}" style="width: 100px; height: 100px; border: 1px solid #ccc; padding: 2px;">
            <span style="display: block; font-size: 7.5pt; color: #888888; text-align: center; margin-top: 5px; width: 100px; float: right;">Escanear QR para verificar originalidad</span>
        </div>
    </div>
    ...
    <div class="signature-section">
        ...
        <div class="signature-box" style="float: right;">
            <!-- Rule #10: Administrator shown as responsible instead of technician -->
            ...
            <div class="signature-line"></div>
            <span style="font-size: 9pt; font-weight: bold;">{{ $admin ? $admin->nombre_completo : 'Administración Central' }}</span><br>
    ...
    <!-- Footer -->
    <div class="footer">
        IMPORTADORA MARTINEZ © {{ date('Y') }} — Sistema de Gestión Blindado Legalmente — Software Costo Cero
    </div>
